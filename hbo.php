...
<div class="highlight-list2">
	...
	<ul>
		...
		<li><a href="hbo.php" class="active" class = "shows_font">HBO</a></li>
		<li><a href="milestones.php"  class = "shows_font">Milestones</a></li>
		<li><a href="territories.php"  class = "shows_font">Territories</a></li>
	</ul>
</div>
<div class="about-us-text">
	<p>Launched in September 2000, HBO is a 24-hour English language movie channel offering viewers in South Asia (India, Pakistan, Maldives and Bangladesh).  HBO brings the best of Hollywood by premiering top blockbuster movies on television first in South Asia through 15+ studios and independent movie companies, including Paramount, NBC Universal and Warner Bros. </p>
