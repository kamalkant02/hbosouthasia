...
<?php include_once("header.php");?>
    <div id="block_schedule_header" class="clearfix movie_title">
      <div class="container clearfix font_content font_block_header shows_font special_font title_block">
        <div class="movie_title">Search Results for "<?php echo $_REQUEST['search_name']; ?>"</div>
...
$split_stemmed = split(" ",$searchtext);
    ...
    $sql_search = "SELECT DISTINCT * FROM (((SELECT DISTINCT *,1 as relevance
					FROM b_movies
					...
					and Status=1 )) 
					UNION ";         
	$sql_search .= "(SELECT DISTINCT *,3 as relevance FROM b_movies WHERE (";
