...
<!--                    <li><a class="menu_channel menu_channel_hits " href="http://hbohits.in/" target="_blank"></a></li>
                ...
                <div class="fb-btn-wrap">
                    <a href="http://www.facebook.com/HBOIndia" target="_blank">
                        <img alt="" title="" src="assets/img/core/fb-btn.png">
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="clearfix" id="page_nav_container">
            <div class="container clearfix">
                <div id="nav_now_showing">
                    ...
                    <div style="position:absolute; left: 0px; bottom: 10px;" class="pre-nav">
                        <h2><a class="font_content font_small" href="<?php echo $site; ?>/movie-schedule.php">Schedule</a></h2>
                    </div>
                </div>
