            ...
            <div class="container clearfix section group channel_section_header">
                <div class="schedule-wrap">
                    ...
                    <div class="col" id="block_schedule_content">
                        ...
                        <div class="block_schedule_nav lft-arw">
                            <div class="" id="block_schedule_nav_left" onClick="getPlanerlist(document.getElementById('txtpredate').value);
                                return false;" ><i class="fa fa-chevron-left"></i>                            
                            </div>
                        </div>
                        ...
                        <div class="block_schedule_nav rgt-arw">
                            <div class="" id="block_schedule_nav_right" onClick="getPlanerlist(document.getElementById('txtnextdate').value);
                                    return false;"><i class="fa fa-chevron-right"></i>
                            </div>
                        </div>
                    </div>
                </div>
...
AND DATE(AiringDateTime) BETWEEN '" . $fromdate . "' AND '" . $todate . "' AND Status=1 ORDER BY AiringDateTime ASC LIMIT 3";
                    ...
                    <?php } ?>
                    <!--div class="col span_7_of_15 font_content week_block_margin pull-right" style="min-height:560px;"-->
                    <div class="col-sm-6">
                        <?php
                        $fromdate = date('Y-m-d');
                            ...
                            <div class="weekly-update-bg pl">
                                ...
                                <div class="col-sm-6 col-xs-12">
                                        <div class="weekly_block_small_thumb <?php echo $divclass; ?>">
                                            ...
                                            <a title="<?php echo $row['Title']; ?>" href="<?php echo getmoviename($row['Title'], $row['MovieID']) ?>"><img width="225" height="150" border="0" alt="<?php echo $row['Title']; ?>" title="<?php echo $row['Title']; ?>" src="http://www.hbosouthasia.com/<?php echo $row['FilePath']; ?>"></a> 
                                        </div>
                                    </div>
                                        <?php
                                        if ($i == 3) {
